...
const mockAnnouncements: Announcement[] = [
  {
    ...
    category: "emergency",
    priority: "high",
    content: "All residents are required to participate in the emergency evacuation drill scheduled for next week.",
    status: "published",
  ...
  },
  {
    ...
    category: "event",
    priority: "medium",
    content: "Join us for a disaster preparedness training workshop this Saturday at the community center.",
    status: "published",
  ...
  },
  {
    ...
    category: "notice",
    priority: "high",
    content: "Heavy rainfall expected in the next 48 hours. Please take necessary precautions.",
    status: "published",
...
export default function AnnouncementManagement() {
  ...
  const [currentAnnouncements, setCurrentAnnouncements] = useState<Announcement[]>(mockAnnouncements)
  ...
  const handleFormSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      if (editingId) {
        setAnnouncements((prev) => prev.map((a) => (a.id === editingId ? announcementData : a)))
